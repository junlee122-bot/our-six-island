...
고스톱에서 사용하는 원본 화투 SVG 중 `m01-01`~`m10-02`의 20장(각 월의 01·02 파일)을 수정 없이 재사용합니다. Spenĉjo / Marcus Richert / Louie Mantia Jr.의 CC BY-SA 4.0 출처와 아래 화투 라이선스를 유지합니다. 새 천 테이블·패 뒷면·월 표시·배분 모션은 CSS로 제작했으며 추가 이미지 다운로드나 생성 없이 기존 72개 내장 에셋을 사용합니다. 카드 자체가 벡터라 확대해도 선명합니다.
