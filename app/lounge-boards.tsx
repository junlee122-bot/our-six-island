...
import { chessBoard, type ChessMatch } from './lounge-chess';
  ...
  return (
    <div className="l-chess-layout">
      ...
      <aside className="l-game-aside">
        <span className="l-kicker">CHESS / 2 PLAYERS</span>
        <h3>한 수의 여유</h3>
        <p>
          {seat < 0
            ? '관전 중이에요. 친구들의 다음 수를 지켜봐 주세요.'
            : '기물을 선택하면 갈 수 있는 칸이 표시돼요. 캐슬링·앙파상·승급을 지원하며, 3회 반복과 50수는 자동 무승부로 처리합니다.'}
        </p>
