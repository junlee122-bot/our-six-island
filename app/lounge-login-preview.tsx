  ...
  return (
    <div className="l-login-preview" data-actor={actor}>
      <div className="l-login-stage">
        ...
        <div className="l-login-entrance" key={`${actor}-${replay}`}>
          <img
            ...
            draggable={false}
          />
          <span className="l-login-wave" aria-hidden="true"><Hand size={24} /></span>
        </div>
      ...
      <div className="l-login-caption">
        <span><strong>{friend.name}</strong><small>{friend.username} · 나의 캐릭터</small></span>
        <button
          type="button"
