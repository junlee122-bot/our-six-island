...
export const FRIENDS=[
 {name:'체리',look:'붉은 단발 · 검정 티',color:'#ebafae',x:650,y:565,greeting:'왔구나! 우리 여섯이 모이니까 여기가 진짜 우리 섬 같아.'},
 {name:'모카',look:'어깨 길이 머리 · 둥근 안경',color:'#e4bc8c',x:925,y:670,greeting:'오늘은 천천히 걸어 보자. 파도 소리도 꽤 괜찮거든.'},
 {name:'구름',look:'긴 머리 · 크림색 셔츠',color:'#a7c9cd',x:485,y:535,greeting:'길가에 핀 꽃 봤어? 소풍 자리에 조금 놓으면 예쁘겠다.'},
 {name:'소금',look:'짧은 검정 머리 · 흰 셔츠',color:'#a7c4df',x:1030,y:500,greeting:'서두를 일은 없어. 오늘 할 일은 즐겁게 노는 거니까!'},
 {name:'밤이',look:'가르마 단발 · 안경',color:'#b7b797',x:660,y:410,greeting:'우리가 좋아하는 것들로 이 섬을 채워 가자.'},
 {name:'도토',look:'갈색 모자 · 검정 티',color:'#d5b095',x:1110,y:380,greeting:'여섯 명이 다 모이면 소풍 가자. 내가 자리는 봐 뒀어!'},
];
